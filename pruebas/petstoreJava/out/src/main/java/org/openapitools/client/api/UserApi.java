...
public class UserApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> successful operation </td><td>  * Set-Cookie - Cookie authentication key for use with the &#x60;api_key&#x60; apiKey authentication. <br>  * X-Rate-Limit - calls per hour allowed by the user <br>  * X-Expires-After - date in UTC when toekn expires <br>  </td></tr>
     ...
     */
    public okhttp3.Call updateUserCall(User user, String username, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = user;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateUserValidateBeforeCall(User user, String username, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateUserCall(user, username, _callback);
        return localVarCall;
    ...
    public ApiResponse<Void> updateUserWithHttpInfo(User user, String username) throws ApiException {
        okhttp3.Call localVarCall = updateUserValidateBeforeCall(user, username, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call updateUserAsync(User user, String username, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateUserValidateBeforeCall(user, username, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
