...
public class WatchedSeries {
	...
	public String toString() {
		return "WatchedSeries [id=" + id + ", title=" + title + ", genre=" + genre + ", numEpisodes=" + numEpisodes
				+ ", startYear=" + startYear + ", additionalProperties=" + additionalProperties + "]";
	}

	public WatchedSeries(String id, String title, String genre, String numEpisodes, String startYears) {
		super();
		this.id = id;
		this.title = title;
		this.genre = genre;
